...
Unity 참고 프로젝트의 실제 Hub 씬에 저장된 베이지 픽셀 디자인을 현재 Unreal 프로토타입의 메뉴·팬·냄비·일시정지·결산에 적용했습니다. 이 팝업 작업에서는 정상 상태 HUD와 영업 규칙, 저장 자료형을 유지했습니다. 이후 요청으로 추가한 메인 HUD 디자인은 [MAIN_HUD_DESIGN.md](MAIN_HUD_DESIGN.md)에 별도로 기록합니다.
...
Unity 원본은 읽기 전용으로 참고했습니다. 복사한 Regular/Bold TTF의 SHA-256은 원본과 동일하며, 기존 플레이어와 기존 GameMode 자산도 기준 해시와 같습니다. 원본 글꼴의 라이선스 안내를 `SourceAssets/Fonts`에 함께 보관했습니다. 전체 마이그레이션은 실행하지 않았습니다.
...
물리 키보드·마우스의 수동 플레이와 재미에 대한 사람의 평가는 자동 검증 결과와 구분합니다. 기존 이동·충돌 검사에서 남아 있던 항목은 [기존 충돌 기준](../../Validation/BASELINE.md)를 따릅니다. 이번 팝업 변경으로 기존 플레이어 그래프를 수정하지 않았습니다.

## 최종 화면

![메뉴 선택](../../../Saved/PopupDesignQA/After/20260914T122845_991324Z/1280x720/01_menu_selected.png)

[변경 전 메뉴](../../../Saved/PopupDesignQA/Before/02_menu.png) · [1080p 냄비](../../../Saved/PopupDesignQA/After/20260914T122845_991324Z/1920x1080/03_pot.png) · [세로 여백 결산](../../../Saved/PopupDesignQA/After/20260914T122845_991324Z/1189x862/05_summary.png)
