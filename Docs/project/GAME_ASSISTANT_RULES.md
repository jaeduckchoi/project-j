...
- 작업 하네스는 `Docs/README.md`, 작업별 세부 진입점은 `GAME_DOCS_INDEX.md`, 실행 절차는 `AGENT_WORKFLOW.md`, 정본 관계는 `SOURCE_OF_TRUTH.md`를 따른다.
...
- 새 지침이 필요하면 먼저 정본 문서 하나를 정하고, 하네스와 엔트리, 인덱스에는 링크와 짧은 설명만 둔다.
