...
- `Assets/Level/Scenes`의 실제 씬 직렬화 값이 정본입니다.
...
- 씬 구조 정리: `Assets/Code/Editor/PrototypeSceneHierarchyOrganizer.cs`
...
- 허브 논리 타일 계약: `Assets/Code/Scripts/Exploration/World/HubRoomLayout.cs`
...
- UI 구조: `Assets/Code/Scripts/UI/UIManager.cs`, `Assets/Code/Scripts/UI/Layout/PrototypeUISceneLayoutCatalog.cs`, `PrototypeUILayout*.cs`, `PrototypeUIObjectNames.cs`
