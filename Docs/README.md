...
이 문서는 처음 읽는 사람과 에이전트를 위한 `Docs` 작업 하네스다. 루트 엔트리에서 들어온 뒤 어떤 정본 문서를 읽고 어떤 범위를 피해야 하는지 안내하며, 세부 규칙과 도메인 기준은 하위 정본 문서에서만 관리한다.

## 최소 읽기 순서

1. [AGENTS.md](../AGENTS.md) 또는 [CLAUDE.md](../CLAUDE.md)
2. 이 작업 하네스의 문서 계층과 작업별 시작점
3. [GAME_ASSISTANT_RULES.md](Project/GAME_ASSISTANT_RULES.md)
4. [GAME_DOCS_INDEX.md](Project/GAME_DOCS_INDEX.md)
5. 현재 작업의 1차 정본 문서 1개
6. 코드, 씬, generated 자산, Unity 메타데이터를 건드리면 [SOURCE_OF_TRUTH.md](Project/SOURCE_OF_TRUTH.md)
...
- [Skills](../Skills): 루트의 에이전트 워크플로 자산. 게임 규칙과 정본 관계는 `Docs/Project`가 소유한다.

## 작업별 시작점

- 규칙 체계, 문서 하네스, 스킬 경로 정리: [GAME_DOCS_INDEX.md](Project/GAME_DOCS_INDEX.md), [GAME_ASSISTANT_RULES.md](Project/GAME_ASSISTANT_RULES.md), [SOURCE_OF_TRUTH.md](Project/SOURCE_OF_TRUTH.md)
