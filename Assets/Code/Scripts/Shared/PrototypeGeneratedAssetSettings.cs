...
#if UNITY_EDITOR
        public const string AssetPath = ProjectAssetPaths.PrototypeGeneratedAssetSettingsAssetPath;
#endif

        private const string DefaultResourcesGeneratedRoot = ProjectAssetPaths.GeneratedResourcesRoot;
