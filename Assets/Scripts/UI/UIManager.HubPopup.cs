...
namespace UI
{
    public partial class UIManager
    {
            ...
            Color goldAccent)
        {
            ...
            ApplyNamedRectLayout("TopLeftPanel", PrototypeUILayout.TopLeftPanel(isHubScene));
            ...
            ApplyRectLayout(goldText != null ? goldText.rectTransform : null, PrototypeUILayout.GoldText(isHubScene));
            ...
            ApplyScreenTextStyle(
                ...
                false,
                0f,
                isHubScene ? new Vector4(0f, 0f, 4f, 0f) : new Vector4(6f, 2f, 6f, 2f),
                !isHubScene);
            if (goldText != null)
            {
                goldText.enableAutoSizing = !isHubScene;
                goldText.fontSizeMin = isHubScene ? 18f : goldText.fontSizeMin;
                goldText.fontSizeMax = isHubScene ? 22f : goldText.fontSizeMax;
