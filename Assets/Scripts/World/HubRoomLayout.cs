...
namespace World
{
    ...
    public static class HubRoomLayout
    {
        ...
        public static readonly Vector3 BottomWallColliderPosition = new(2.42f, -4.74f, 0f);
        public static readonly Vector3 BottomWallColliderScale = new(13.05f, 0.62f, 1f);
