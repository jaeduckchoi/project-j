...
{
    /// <summary>
    /// 플레이어가 손에 들고 있거나 FrontCounter 슬롯에 올려 둔 단일 주방 항목을 나타냅니다.
    ...
    public sealed class KitchenCarryItem
    {
        ...
        /// <summary>
        /// FrontCounter에 올려 둔 여러 항목을 BackCounter로 옮기는 묶음 항목을 만듭니다.
        /// </summary>
    ...
    /// <summary>
    /// FrontCounter의 여러 슬롯 항목을 순서와 무관한 조합 단위로 묶은 값입니다.
    /// BackCounter 조리 판정은 이 묶음의 시그니처를 기준으로 수행합니다.
    /// </summary>
    [Serializable]
