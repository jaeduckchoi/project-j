...
이 폴더는 `Assets/Generated`, `Assets/Resources/Generated`에 반영하거나 참고하는 UI 디자인 소스를 모아 둔 위치다.
...
- 실제 반영이 필요하면 `Assets/Generated`, `Assets/Resources/Generated`, 빌더 경로를 함께 맞춘다.
