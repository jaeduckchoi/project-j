...
- 채집 대상이 도구 부족이나 진행 단계로 막혀 있어도 차단 사유는 항상 표시한다.
...
- 탐험 지역 진입 포탈은 `Morning Explore` 단계에서만 열린다.
- 허브 복귀 포탈은 오후 단계 이후에도 열려 있어 하루 루프가 자연스럽게 마무리된다.
